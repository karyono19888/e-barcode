	...
	<section class="content">
		<div class="row">
			<div class="col-sm">
				<div class="card">
					<div class="card-body">
						<form action="<?= base_url('Produksi/Generate/bc_all'); ?>" method="GET" target="_blank">
							<div class="form-row">
								<div class="col-sm-4">
									...
									?>
										<tr class="justify-content-center">
											...
											<td class="text-center">
												<img class="img-rounded" src="<?= ($row['t_bc_img'] == 'no-qrcode.png' ? base_url('assets/dist/img/no-qrcode.png') : base_url('assets/produksi/' . $row['t_bc_img'])); ?>" style="width:100px;">
											</td>
											<td class="text-center">
												<a href="<?= base_url('Produksi/Generate/mpdf/' . $row['t_bc_id']); ?>" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Print</a>
											</td>
										</tr>
									<?php } ?>
								</tbody>
