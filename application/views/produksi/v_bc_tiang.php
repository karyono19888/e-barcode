...
<div class="content-wrapper">
	...
	<section class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1><i class="fas fa-qrcode"></i> Barcode Tiang</h1>
				</div>
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"><a href="#">Produksi</a></li>
						<li class="breadcrumb-item active">Barcode Tiang</li>
					</ol>
				</div>
			</div>
		</div><!-- /.container-fluid -->
			...
			<div class="row">
				...
				<div class="col-lg-3 col-6">
					...
					<div class="small-box bg-warning">
						<div class="inner">
							<h3>500<sup style="font-size: 20px"> Barcode</sup></h3>
		...
		<div class="row">
			...
			<div class="col-sm-9">
				<div class="card shadow mb-3">
					<div class="card-body">
						<form action="<?= base_url('Produksi/Tiang/bc_all'); ?>" method="GET" target="_blank">
							<div class="form-row">
								<div class="col-sm-4">
									...
									?>
										<tr class="justify-content-center">
											...
											<td class="text-center">
												<img class="img-rounded" src="<?= ($row['t_bc_img'] == 'no-qrcode.png' ? base_url('assets/dist/img/no-qrcode.png') : base_url('assets/tiang/' . $row['t_bc_img'])); ?>" style="width:100px;">
											</td>
											<td class="text-center">
												<a href="<?= base_url('Produksi/Tiang/mpdf/' . $row['t_bc_id']); ?>" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Print</a>
											</td>
										</tr>
									<?php } ?>
								</tbody>
...
<script>
	...
	$(document).on("click", "#tombol_generate", function() {
		if (validasi3()) {
			...
			$.ajax({
				type: 'POST',
				url: '<?= site_url('Produksi/Tiang/generate') ?>',
				data: data,
				success: function(response) {
					...
					setTimeout(() => {
						window.location.assign('<?php echo site_url("Produksi/Tiang") ?>');
					}, 1500);
				}
			});
		}
	...
	$(document).ready(function() {
		$("#start_bc").select2({
			theme: 'bootstrap4',
			ajax: {
				url: '<?= base_url() ?>Produksi/Tiang/getkode_bc',
				type: "post",
				dataType: 'json',
				delay: 200,
	...
	$(document).ready(function() {
		$("#end_bc").select2({
			theme: 'bootstrap4',
			ajax: {
				url: '<?= base_url() ?>Produksi/Tiang/getkode_bc2',
				type: "post",
				dataType: 'json',
				delay: 200,
				data: function(params) {
