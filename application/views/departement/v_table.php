					...
					?>
						<tr>
							...
							<td class="text-center">
								<?php if ($a['m_dep_status'] == "Aktif") : ?>
									<span class="badge badge-pill badge-primary"><?= $a['m_dep_status']; ?></span>
								<?php else : ?>
									<span class="badge badge-pill badge-primary"><?= $a['m_dep_status']; ?></span>
								<?php endif; ?>
							</td>
							<td class="text-center">
								<button type="button" data-id="<?= $a['m_dep_id']; ?>" class="btn bg-gradient-info Preview">
									Preview
								</button>
							</td>
						</tr>
