...
<img class="animation__shake rounded-circle" src="<?= base_url('assets'); ?>/dist/img/adw1.jpg" alt="AdminLTELogo" height="200" width="200">
</div> -->
		<!-- Navbar -->
		...
		<i class="fas fa-th-large"></i>
				...
				<li class="nav-item dropdown no-arrow">
					<a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
						...
						<img class="img-profile rounded-circle" src="<?= base_url('assets/dist/img/user2-160x160.jpg'); ?>">
					</a>
