					...
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="m_org_kode" name="m_org_kode" value="<?= $data['m_org_kode']; ?>">
								<input type="hidden" class="form-control" id="m_org_id" name="m_org_id" value="<?= $data['m_org_id']; ?>">
							</div>
							<div class="form-group">
								<label for="m_org_nama">Nama</label>
								<input type="text" class="form-control" id="m_org_nama" name="m_org_nama" value="<?= $data['m_org_nama']; ?>">
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<label for="m_org_alamat">Alamat</label>
								<textarea class="form-control" name="m_org_alamat" id="m_org_alamat" cols="30" rows="3"><?= $data['m_org_alamat']; ?></textarea>
							</div>
							<div class="form-group">
								<label for="m_org_status">Status</label>
								<select class="form-control select2" style="width: 100%;" name="m_org_status" id="m_org_status">
									<option selected="selected" value="<?= $data['m_org_status']; ?>"><?= $data['m_org_status']; ?></option>
...
<script>
	...
	$(document).on("click", "#TombolSimpan", function() {
		if (validasi()) {
			...
			$.ajax({
				type: 'POST',
				url: '<?= base_url('Master/Organisasi/SimpanEdit'); ?>',
				data: data,
